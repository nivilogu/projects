...
class Nivetha:
   ...
   select_l = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div[2]/div[3]/div/div[2]/div/div/div[1]/div/div/label/span/i'
   delete_l = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div[2]/div[2]/div/div/button'
   confirmdel_l = '/html/body/div/div[3]/div/div/div/div[3]/button[2]'
   ...
   def PIM(self):    
        ...
        sleep(3)
        self.driver.find_element(by=By.XPATH, value=self.select_l).click()
        self.driver.find_element(by=By.XPATH, value=self.delete_l).click()
        self.driver.find_element(by=By.XPATH, value=self.confirmdel_l).click()
