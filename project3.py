...
class Nivetha:
   ...
   Nickname = 'nilan'
   Nickname_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[1]/div[2]/div/div/div[2]'  
   save_l ='/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[5]/button' 
   otherid_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[2]/div[1]/div[2]/div/div[2]'
   otherid = '202023'
   dln_l = '/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[2]/div[2]/div[1]/div/div[2]/input'
   dln = '238434388423'
   ...
   def Addemployee(self):
        ...
        #self.driver.find_element(by=By.XPATH, value=self.otherid_l).send_keys(self.otherid)
        #self.driver.find_element(by=By.XPATH, value=self.dln_l).send_keys(self.dln)
